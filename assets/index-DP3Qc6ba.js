...
var best_index : i32 = 0;`,`if (${n.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`},Bt=(e,t,r,n,i,s=e.dataType,o,u)=>{let d=[{type:12,data:Math.ceil(fe.size(e.dims)/4)}];return o&&d.push(...o),{name:t,shaderCache:{hint:i,inputDependencies:["type"]},getShaderSource:f=>ph(f,fe.size(e.dims),e.dataType,s,r,n,u),getRunData:f=>({outputs:[{dims:e.dims,dataType:s}],dispatchGroup:{x:Math.ceil(fe.size(f[0].dims)/64/4)},programUniforms:d})}},Xy=e=>{e.compute(Bt(e.inputs[0],"Abs","abs"))},Yy=e=>{e.compute(Bt(e.inputs[0],"Acos","acos"))},Qy=e=>{e.compute(Bt(e.inputs[0],"Acosh","acosh"))},Zy=e=>{e.compute(Bt(e.inputs[0],"Asin","asin"))},Jy=e=>{e.compute(Bt(e.inputs[0],"Asinh","asinh"))},ev=e=>{e.compute(Bt(e.inputs[0],"Atan","atan"))},tv=e=>{e.compute(Bt(e.inputs[0],"Atanh","atanh"))},rv=e=>Lt(e),av=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(Bt(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},hh=e=>{let t,r,n=e.length>=2&&e[1].data!==0,i=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=n?e[1].getFloat32Array()[0]:-34028234663852886e22,r=i?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=n?e[1].getUint16Array()[0]:64511,r=i?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return Lt({min:t,max:r})},nv=(e,t)=>{let r=t||hh(e.inputs),n=wr(e.inputs[0].dataType);e.compute(Bt(e.inputs[0],"Clip",i=>`clamp(${i}, vec4<${n}>(uniforms.min), vec4<${n}>(uniforms.max))`,void 0,r.cacheKey,void 0,[{type:e.inputs[0].dataType,data:r.min},{type:e.inputs[0].dataType,data:r.max}],[{name:"min",type:n},{name:"max",type:n}]),{inputs:[0]})},iv=e=>{e.compute(Bt(e.inputs[0],"Ceil","ceil"))},sv=e=>{e.compute(Bt(e.inputs[0],"Cos","cos"))},ov=e=>{e.compute(Bt(e.inputs[0],"Cosh","cosh"))},xs=e=>Lt(e),uv=(e,t)=>{let r=wr(e.inputs[0].dataType);e.compute(Bt(e.inputs[0],"Elu",n=>`elu_vf32(${n})`,`
...
}`,lv=e=>{let t=wr(e.inputs[0].dataType);e.compute(Bt(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,uu(t)))},dv=e=>{e.compute(Bt(e.inputs[0],"Exp","exp"))},fv=e=>{e.compute(Bt(e.inputs[0],"Floor","floor"))},cv=e=>{let t=wr(e.inputs[0].dataType);e.compute(Bt(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,uu(t)))},pv=(e,t)=>{let r=wr(e.inputs[0].dataType);e.compute(Bt(e.inputs[0],"LeakyRelu",n=>`select(leaky_relu_alpha_ * ${n}, ${n}, ${n} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},hv=e=>{e.compute(Bt(e.inputs[0],"Not",t=>`!${t}`))},mv=e=>{e.compute(Bt(e.inputs[0],"Neg",t=>`-${t}`))},gv=e=>{e.compute(Bt(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},yv=e=>{let t=wr(e.inputs[0].dataType);e.compute(Bt(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},vv=e=>{e.compute(Bt(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},_v=e=>Lt(e),bv=(e,t)=>{let r=wr(e.inputs[0].dataType);e.compute(Bt(e.inputs[0],"HardSigmoid",n=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${n} + vec4<${r}>(${t.beta})))`,void 0,t.cacheKey))},wv=e=>{e.compute(Bt(e.inputs[0],"Sin","sin"))},xv=e=>{e.compute(Bt(e.inputs[0],"Sinh","sinh"))},$v=e=>{e.compute(Bt(e.inputs[0],"Sqrt","sqrt"))},Ev=e=>{e.compute(Bt(e.inputs[0],"Tan","tan"))},ad=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,Sv=e=>{e.compute(Bt(e.inputs[0],"Tanh",ad))},Ud=(e="f32")=>`
...
`,Vd=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,Tv=e=>{let t=wr(e.inputs[0].dataType);e.compute(Bt(e.inputs[0],"FastGelu",Vd,Ud(t),void 0,e.inputs[0].dataType))},kv=(e,t)=>{let r=wr(e.inputs[0].dataType);return e.compute(Bt(e.inputs[0],"ThresholdedRelu",n=>`select(vec4<${r}>(0.0), ${n}, ${n} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${r}>(${t.alpha});`,t.cacheKey)),0},Av=e=>{e.compute(Bt(e.inputs[0],"Log","log"))},mh=(e,t)=>`
...
`)},Eh=(e,t,r,n)=>{let i=fe.size(r),s=new Array(e.length),o=new Array(e.length),u=0,d=[],f=[],h=[{type:12,data:i}];for(let $=0;$<e.length;++$)u+=e[$].dims[t],s[$]=u,f.push(e[$].dims.length),o[$]=be(`input${$}`,n,f[$]),d.push("rank"),h.push({type:12,data:s[$]});for(let $=0;$<e.length;++$)h.push(...st(e[$].dims));h.push(...st(r));let m=rt("output",n,r.length),g=m.indicesGet("indices",t),v=Array.from(Array(s.length).keys()).map($=>`uniforms.sizeInConcatAxis${$}`).join(","),_=$=>`
  ...
  ${$.mainStart()}
    ...
    ${$h(o,m)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:r,dataType:n}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:h}),getShaderSource:_}},Fv=(e,t)=>{let r=e.inputs,n=r[0].dims,i=fe.normalizeAxis(t.axis,n.length);wh(r,i);let s=n.slice();s[i]=r.reduce((u,d)=>u+(d.dims.length>i?d.dims[i]:0),0);let o=r.filter(u=>fe.size(u.dims)>0);e.compute(Eh(o,i,s,r[0].dataType),{inputs:o})},Uv=e=>Lt({axis:e.axis})}),xn,$n,En,yf,kn=Fe(()=>{ct(),_t(),xn=(e,t,r="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${r}(uniforms.clip_min)), ${t}(${r}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${r}(uniforms.alpha) * value + ${r}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${r}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
...
`}),Es,_f,bf=Fe(()=>{ct(),_t(),xt(),kn(),Es=(e,t,r,n,i)=>{let s=n-r;return`
...
`}return te};return`
  ...
  ${B.mainStart()}
    ...
    ${Es("a_indices",ae,ae.rank-2,W.rank,"batch_indices")}
    ...
    ${Es("b_indices",Q,Q.rank-2,W.rank,"batch_indices")}
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${m};${g};${v};${i}`,inputDependencies:$?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:s?s(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:b}),getShaderSource:N}}}),Sh,Th,Wd,nd,kh,qd,Ah,mu,wf=Fe(()=>{ct(),_t(),xt(),kn(),bf(),vf(),Sh=(e,t)=>e?`
...
`},Ah=(e,t,r,n,i=!1)=>{let[s,o,u,d]=n,f=lr(n[0].type.tensor);return`
    fn mm_readA(batch: i32, row: i32, colIn: i32, batchIndices: ${s.type.indices}) -> ${pr(e,f)} {
      ...
      if(row < uniforms.dim_a_outer && col < uniforms.dim_inner)
      {
        ...
        ${Es("aIndices",o,o.rank-2,s.rank,"batchIndices")}
    ...
    fn mm_readB(batch: i32, row: i32, colIn: i32, batchIndices: ${s.type.indices}) -> ${pr(e,f)} {
      ...
      if(row < uniforms.dim_inner && col < uniforms.dim_b_outer)
      {
        ...
        ${Es("bIndices",u,u.rank-2,s.rank,"batchIndices")}
...
`,gm=(e,t,r)=>(()=>{switch(r.mode){case"nearest":return`
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:u,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:f}),getShaderSource:h},{inputs:[t,r],outputs:[-1]})[0]},$s=(e,t,r,n,i,s,o,u)=>{let d=s;if(o&&fe.size(o.dims)>0){if(n===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return d=_m(e,s,o,t,n,r*i,u),d=d.reshape([t,n,r,i]),r===1||n===1?d:e.compute(zr(d,pd.perm),{inputs:[d],outputs:[-1]})[0]}else return s.dims.length===3&&(d=s.reshape([t,n,r,i])),r===1||n===1?d:e.compute(zr(d,pd.perm),{inputs:[d],outputs:[-1]})[0]},w0=(e,t)=>{let r=vm(e.inputs,t),n=e.inputs[0],i=Sr(e.inputs,1),s=Sr(e.inputs,2),o=Sr(e.inputs,3),u=Sr(e.inputs,4),d=Sr(e.inputs,5),f=Sr(e.inputs,6),h=Sr(e.inputs,7);if(n.dims.length===5)throw new Error("Packed QKV is not implemented");if(i?.dims.length===5)throw new Error("Packed KV is not implemented");let m=i&&s&&i.dims.length===4&&s.dims.length===4,g=$s(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,n,o,0);if(m)return As(e,g,i,s,u,void 0,f,h,d,r);if(!i||!s)throw new Error("key and value must be provided");let v=$s(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.headSize,i,o,r.hiddenSize),_=$s(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.vHeadSize,s,o,2*r.hiddenSize);As(e,g,v,_,u,void 0,f,h,d,r)}}),bm,wm,xm,$m,Kd,$0,E0,S0=Fe(()=>{ct(),_t(),Zt(),xt(),bm=e=>{if(!e||e.length<1)throw new Error("too few inputs")},wm=(e,t)=>{let r=[],n=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(i=>r.push(Number(i))),n=r.length),Lt({numOutputs:n,axis:t.axis,splitSizes:r})},xm=e=>`
...
`}
      ...
      }`},B=[{dims:u,dataType:e[0].dataType}];return r>1&&B.push({dims:h,dataType:1}),r>2&&B.push({dims:h,dataType:1}),r>3&&B.push({dims:s,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${T};${v};${_};${$}`,inputDependencies:e.map((W,ae)=>"type")},getShaderSource:N,getRunData:()=>({outputs:B,dispatchGroup:{x:Math.ceil(d/f)},programUniforms:b})}},Y0=(e,t)=>{hg(e.inputs);let r=[0];e.outputCount>1&&r.push(-3),e.outputCount>2&&r.push(-3),e.outputCount>3&&r.push(3),e.compute(mg(e.inputs,t,e.outputCount,!1),{outputs:r})}}),gg,ys,yg,Ad,vg,_g,Q0,Z0,U1=Fe(()=>{ct(),_t(),Zt(),xt(),gg=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,n)=>{if(e[n+1].dataType!==6&&e[n+1].dataType!==7)throw new Error(`Input ${n} must be an array of int32 or int64`)})},ys=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(n=>r.push(Number(n)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(n=>r.push(Number(n)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},yg=(e,t)=>{if(e.length>1){let r=ys(e,1),n=ys(e,2),i=ys(e,3);return i.length===0&&(i=[...Array(e[0].dims.length).keys()]),Lt({starts:r,ends:n,axes:i})}else return t},Ad=(e,t,r,n,i)=>{let s=e;return e<0&&(s+=r[n[t]]),i[t]<0?Math.max(0,Math.min(s,r[n[t]]-1)):Math.max(0,Math.min(s,r[n[t]]))},vg=(e,t,r)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
 ...
 * limitations under the License.
 * =============================================================================
 */function ai(e){return e.replace(/\.\d+$/,"")}function J1(e,t){return e.map(r=>r==="batch"?t:r===-1?1:r)}class If{constructor(t){this.path=t,this.session=null,this.hStateInfo={}}async init(){this.session=await tf.create(this.path),this.hStateInfo={};for(let t=0;t<this.session.inputNames.length;t++){const r=this.session.inputNames[t],n=this.session.inputMetadata[t];if(ai(r).startsWith("h")){const i=n.shape.map(s=>s===-1?1:s);this.hStateInfo[r]=i}}this.createState()}createState(t=1){if(!this.session)throw new Error("Call init() first");const r={};for(const[n,i]of Object.entries(this.hStateInfo)){const s=J1(i,t),o=s.reduce((d,f)=>d*f,1),u=new Float32Array(o);r[n]=new Pr("float32",u,s)}return r}async call(t,r){if(!this.session)throw new Error("Call init() first");const n={};for(const[d,f]of Object.entries(t)){if(ai(d).startsWith("h"))continue;const h=this.session.inputNames.indexOf(d);if(h===-1)throw new Error(`Unknown input '${d}'`);const g=this.session.inputMetadata[h].shape.map(v=>v==="batch"||v===-1?1:v);n[d]=new Pr("float32",Float32Array.from(f),g)}for(const[d,f]of Object.entries(r))n[d]=f;const i=await this.session.run(n),s={},o={},u=Object.entries(i).filter(([d])=>ai(d).startsWith("h")).reduce((d,[f])=>{const h=ai(f);return d[h]||(d[h]=[]),d[h].push(f),d},{});for(const d of Object.keys(this.hStateInfo)){const f=ai(d),h=u[f];if(!h||h.length===0)throw new Error(`No output hidden state matches input hidden state base '${f}'`);let m=h.find(g=>g===d);m||(m=h[0]),o[d]=i[m]}for(const[d,f]of Object.entries(i))ai(d).startsWith("h")||(s[d]=Array.from(f.data));return{outputs:s,nextState:o}}}function Cf(e,t,r,n=40){let i=null,s=null,o=null,u=!1;async function d(){e.session||await e.init(),i=e.createState()}async function f(){try{const v=t(),{outputs:_,nextState:$}=await e.call(v,i);i=$,s=r(_)}catch(v){console.error("streamRnn step error:",v)}}async function h(){u||(u=!0,i||await d(),o=setInterval(f,1e3/n))}function m(){u&&(clearInterval(o),o=null,u=!1)}h();function g(){return s}return g.stop=m,g}class fi{constructor(){this.running=!1}run(){}trigger(t,r){let n=!1,i=setInterval(()=>{(n||!this.running)&&clearInterval(i),t()&&(n=!0,r())},100)}blendTo(t){t.out(o0)}}const ex=new If("models/playing.onnx"),Is=Cf(ex,()=>({x:a.fft}),e=>e.output[0]),tx=new If("models/smooth_peak.onnx"),wn=Cf(tx,()=>({x:a.fft}),e=>e.output[0]),rx=new If("models/momentum.onnx"),Tr=Cf(rx,()=>({x:a.fft}),e=>e.output[0]),ax={playing:Is,smoothPeak:wn,momentum:Tr};class nx extends fi{run(){this.blendTo(solid(0,0,0,1))}}class ix extends fi{run(){let t=osc(7,.1).mask(shape(2,.5,()=>Tr()*.033+wn()*.1)).mask(shape(4,.8,()=>Tr()*.03+wn()*.1)).brightness(()=>-.7+.3*Is()+.6*Tr());this.blendTo(t),this.trigger(()=>Tr()==1,()=>{let r=time;t.blend(src(o0),()=>.2+wn()*.3).color(()=>1-.8*Math.sin(.1*(time-r)),1,1).modulate(noise(10),()=>(time-r)*.005).scale(()=>1+1e-4*(time-r)).rotate(()=>.001*(time-r)).out()})}}class sx extends fi{run(){speed=.0222;let t=osc(48,-.1,0).thresh([.3,.7].fast(.75),0).color(0,0,1).add(osc(28,.1,0).thresh([.3,.7].fast(.75),0).rotate(3.14/4).color(1,0,0).modulateScale(osc(()=>wn(),-.01,0).thresh([.3,.7].fast(.75),0))).diff(osc(28,.1,0).thresh([.3,.7].fast(.5),0).rotate(3.14/2).color(1,0,1).modulateScale(osc(64,-.015,0).thresh([.3,.7].fast(.5),0))).modulateRotate(osc(54,-.005,0).thresh([.3,.7].fast(.25),0)).modulateScale(osc(44,-.02,0).thresh([.3,.7].fast(.25),0)).colorama(()=>Math.sin(time/27)*.01222+9.89).scale(()=>wn()*.1+2.122).brightness(()=>-.2*Is()).contrast(()=>1+Is());t.out(),this.trigger(()=>Tr()==1,()=>{let r=time;t.blend(src(o0),()=>.1+.3*wn()).modulate(noise(10),()=>(time-r)*.005).scale(()=>1-.001*(time-r)).rotate(()=>.01*(time-r)).out()})}}class ox extends fi{run(){shape(()=>Math.sin(time*.1)+3,.5,.01).repeat(5,3,()=>Tr()*0,()=>Tr()*0).scrollY(.01,()=>.01).layer(src(o1).mask(o0).luma(()=>.01+.5*Tr(),()=>Tr()*.5+.1).invert(.2)).modulate(o1,()=>.01+Tr()*.05).out(o0),osc(40,.09,.9).color(.9,0,5).modulate(osc(10).rotate(1,.5)).rotate(1,.2).out(o1)}}class ux extends fi{run(){function t(r=0,n=1){return Math.random()*(n-r)+r}solid(1,1,1).diff(shape(4,.45,.09).repeat(20,10)).modulateScale(osc(2).rotate(t(-.5,.5)),.52).add(src(o0).scale(()=>.97-.1*Tr()).rotate(.012*Math.round(-2)).color(t(),t(),t()).modulateRotate(o0,0).brightness(.15),Tr).brightness(()=>-.5+Tr()).out()}}class lx extends fi{run(){voronoi(350,.15).thresh(.8).thresh(.7).modulateScale(osc(1).modulateRotate(o0,.04)).diff(src(o0).rotate(-.0012).scrollY(0,[-1/199800].fast(.7))).brightness([-.02,-.17].smooth().fast(.5)).scale(()=>1+.05*Tr()).brightness(()=>-.5+.5*Is()).out()}}const vu=[nx,ux,ox,lx,sx,ix],dx=["p"],fx=["i","/"],cx=["a"],px=["s","j"],hx=["d","delete","backspace"],nu=1,Cs={textElementBorder:!1,textElementBorderColor:"#ffffff"},mx=document.getElementById("text"),gx=document.getElementById("visual"),Ss=document.getElementById("edit-panel"),yx=document.getElementById("edit-panel-header"),Lg=document.getElementById("metrics-monitor");let Of=!1,_u={x:0,y:0};yx.addEventListener("mousedown",e=>{const t=document.activeElement.tagName.toLowerCase();t==="input"||t==="label"||(Of=!0,_u.x=e.clientX-Ss.offsetLeft,_u.y=e.clientY-Ss.offsetTop,e.stopPropagation())});document.addEventListener("mousemove",e=>{Of&&(Ss.style.right="",Ss.style.left=`${e.clientX-_u.x}px`,Ss.style.top=`${e.clientY-_u.y}px`)});document.addEventListener("mouseup",()=>{Of=!1});window.controlValues=Cs;const Mg=document.getElementById("textElementBorder"),Ng=document.getElementById("textElementBorderColor");function Rf(){document.querySelectorAll(".text-element").forEach(t=>{Cs.textElementBorder?t.style.boxShadow=`inset 0 0 0 1px ${Cs.textElementBorderColor}`:t.style.boxShadow="none"})}Mg.addEventListener("change",()=>{Cs.textElementBorder=Mg.checked,Rf()});Ng.addEventListener("input",()=>{Cs.textElementBorderColor=Ng.value,Rf()});const Ts=["scale","opacity","rotate"];let si=0,Zr=!1;const vx=new Ow({canvas:gx,detectAudio:!0,enableStreamCapture:!1});let Bd=null;const x_=e=>{a.setBins(24),a.setCutoff(1.5),a.setSmooth(0),speed=1,Bd!==null&&(Bd.running=!1);let t=new e;t.running=!0,t.run(),Bd=t};function $_(){const e=window.devicePixelRatio||1;vx.setResolution(window.innerWidth*e,window.innerHeight*e)}$_();window.addEventListener("resize",$_);window.addEventListener("load",()=>{!isNaN(nu)&&nu>=0&&nu<vu.length&&x_(vu[nu])});let oi=[],Qr=null;document.body.addEventListener("keydown",e=>{if(document.activeElement.tagName.toLowerCase()==="textarea")return;let r=e.key.toLowerCase(),n=parseInt(r);dx.includes(r)&&bx(),fx.includes(r)&&S_(),isNaN(n)||n>=0&&n<vu.length&&x_(vu[n]),Zr&&(cx.includes(r)&&xx(),px.includes(r)&&_x(),hx.includes(r)&&wx(Qr))});function E_(e){si=e,document.getElementById("current-transformation-indicator").textContent=Ts[si]}function _x(){E_((si+1)%Ts.length)}function S_(){Zr=!Zr,E_(0),document.body.classList.toggle("edit-mode",Zr),Zr?a.show():a.hide()}function bx(){document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen().catch(e=>{console.error(`Error attempting fullscreen: ${e.message}`)})}function Qd(e){Qr!==e&&(Qr&&Qr.classList.remove("selected-text-element"),Qr=e,oi=oi.filter(t=>t!==e),oi.unshift(e),Qr&&Qr.classList.add("selected-text-element"))}function wx(e){e!==null&&(e.remove(),oi=oi.filter(t=>t!==Qr),Qr=oi[0]||null,Qr&&Qr.classList.add("selected-text-element"))}function xx(){const e="text",t=document.createElement("div");t.className="text-element",t.style.left="100px",t.style.top="100px",t.style.transform="rotate(0deg) scale(1)",t.innerHTML=`
    <span>${e}</span>
    <textarea name="text">${e}</textarea>
  `;let r=!1,n,i,s,o,u=0,d=1,f=1;t.addEventListener("mousedown",m=>{Zr&&(r=!0,n=m.clientX,i=m.clientY,s=parseFloat(t.style.left),o=parseFloat(t.style.top),Qd(t),m.preventDefault(),m.stopPropagation())}),document.addEventListener("mousemove",m=>{if(!Zr||!r)return;const g=m.clientX-n,v=m.clientY-i;t.style.left=`${s+g}px`,t.style.top=`${o+v}px`}),document.addEventListener("mouseup",()=>{r=!1}),t.addEventListener("wheel",m=>{Zr&&(m.preventDefault(),Ts[si]==="rotate"?(u+=m.deltaY<0?-1:1,h()):Ts[si]==="scale"?(d+=m.deltaY<0?.025:-.025,d=Math.max(.9,d),h()):Ts[si]==="opacity"&&(f+=m.deltaY<0?.05:-.05,f=Math.min(1,Math.max(.1,f)),t.style.opacity=f))});function h(){t.style.transform=`rotate(${u}deg) scale(${d})`}t.addEventListener("dblclick",()=>{Zr&&(t.classList.add("editing"),t.querySelector("textarea").focus())}),t.querySelector("textarea").addEventListener("blur",()=>{const m=t.querySelector("textarea").value;t.querySelector("span").textContent=m,t.classList.remove("editing")}),t.addEventListener("click",()=>{Zr&&(document.querySelectorAll(".text-element").forEach(m=>m.classList.remove("selected")),t.classList.add("selected"))}),mx.appendChild(t),Rf(),Qd(t)}document.body.addEventListener("mousedown",()=>{Zr&&Qd(null)});function T_(){Lg.innerHTML="";for(const[e,t]of Object.entries(ax)){const r=document.createElement("div");let n=t();typeof n=="number"&&(n=n.toFixed(3)),r.textContent=`${e}: ${n}`,Lg.appendChild(r)}}T_();setInterval(T_,100);S_();
